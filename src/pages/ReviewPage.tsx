...
export function ReviewPage({ engine }: { engine: StudyEngine }) {
  ...
  return (
    <AppShell
      title="今日复习"
      subtitle="这个入口负责全局复习调度。当前因为只接入了亚洲单元，所以会优先从亚洲题库里抽取；后续新增单元后，这里会自动混合出题。"
      headerAside={
        <div className="rounded-[1.5rem] bg-ocean-50 px-5 py-4 text-ocean-900">
          <div className="text-sm">待复习知识点</div>
      ...
      <div className="mx-auto max-w-4xl space-y-5">
        <Card>
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <CardTitle>系统已整理好今天该练的内容</CardTitle>
              <CardDescription className="mt-2">
                优先覆盖到期知识点，同时尽量避开你刚练过的题，减少重复感。
              </CardDescription>
            </div>
        ...
        {card ? (
          ...
          <Card className="bg-slate-950 text-white">
            ...
            <CardDescription className="mt-3 text-slate-300">
              你可以继续进入单元训练，也可以切到地图挑战，把识图题再拉一遍。
            </CardDescription>
